...
button_1 = tk.Button(master=frame, text='1', padx=25,
                     pady=5, width=3, command=lambda: myclick(1))
button_1.grid(row=1, column=0, pady=2)
button_2 = tk.Button(master=frame, text='2', padx=25,
                     pady=5, width=3, command=lambda: myclick(2))
button_2.grid(row=1, column=1, pady=2)
button_3 = tk.Button(master=frame, text='3', padx=25,
...
button_subtract = tk.Button(
    master=frame, text="-", padx=25, pady=5, width=3, command=lambda: myclick('-'))
button_subtract.grid(row=6, column=2, pady=2)
